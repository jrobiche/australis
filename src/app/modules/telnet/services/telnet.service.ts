...
import { DirlistEntry, Drivefreespace, TelnetResponse } from '../types/telnet';
...
export class TelnetService {
  ...
  dvdeject(configuration: GameConsoleConfiguration): Promise<TelnetResponse> {
  ...
  magicboot(configuration: GameConsoleConfiguration): Promise<TelnetResponse> {
  ...
  shutdown(configuration: GameConsoleConfiguration): Promise<TelnetResponse> {
